...
**執行方式：**
```bash
uv run python playwright/課程章節/第12章_效能優化/real_example.py
```
...
[專案 12：平行爬取優化 →](../../實戰專案/專案12_平行爬取優化/README.md)

---

[← 上一章：反爬蟲對策](../第11章_反爬蟲對策/README.md) | [返回目錄](../../README.md) | [下一章：實戰專案 →](../../實戰專案/README.md)
